...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_tulpa_cpp_tulpa_fit_spde_nuts", (DL_FUNC) &_tulpa_cpp_tulpa_fit_spde_nuts, 34},
    {NULL, NULL, 0}
};
