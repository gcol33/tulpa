...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_tulpa_cpp_tulpa_fit_spde_nuts", (DL_FUNC) &_tulpa_cpp_tulpa_fit_spde_nuts, 38},
    {NULL, NULL, 0}
};
