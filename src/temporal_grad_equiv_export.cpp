...
Rcpp::List cpp_test_temporal_grad_equiv(Rcpp::NumericVector w, double sigma2,
  ...
  out["rw1_val"]  = tulpa_temporal::rw1_log_lik(wv, sigma2, false, false);
  out["rw1c_val"] = tulpa_temporal::rw1_log_lik(wv, sigma2, true, false);
  out["rw2_val"]  = tulpa_temporal::rw2_log_lik(wv, sigma2, false, false);
  ...
  out["rw1c_dls2"] = tulpa_temporal_grad::rw1_cyclic_grad_log_sigma2(p, n, sigma2);
