...
// =====================================================================
// Proper CAR prior helpers (Q = D - rho*W, full rank for rho in interior)
// =====================================================================
...
double log_prior_car_proper(
    ...
    // log p(phi | tau, rho) = 0.5 * log|tau * Q(rho)|  - 0.5 * tau * phi' Q(rho) phi
    //                       = 0.5 * (n*log(tau) + log|Q(rho)|)  - 0.5 * tau * quad
