// nested_laplace.cpp
// Nested Laplace grid loops for areal/lattice spatial models.
// ICAR nested Laplace: 1D grid over tau_spatial.
// Future: BYM2 nested (2D grid over tau, rho), GP nested, etc.
...
// =====================================================================
// Nested Laplace: C++ grid loop for ICAR spatial
// =====================================================================
...
Rcpp::List cpp_nested_laplace_icar(
    ...
    Rcpp::NumericMatrix all_modes(n_grid, n_x);
    ...
    for (int k = 0; k < n_grid; k++) {
        ...
        tulpa::LaplaceResult res = tulpa::laplace_newton_solve(
...
// =====================================================================
// Nested Laplace: C++ grid loop for BYM2 spatial
// =====================================================================
// 2D grid over (sigma_spatial, rho). At each point:
//   BYM2 precision: Q = tau[rho*Q_icar + (1-rho)*I]
//   where tau = 1/sigma_spatial^2, and rho blends structured (ICAR) vs IID.
...
Rcpp::List cpp_nested_laplace_bym2(
    ...
    return Rcpp::List::create(
        ...
        Rcpp::Named("n_iter") = n_iters,
        Rcpp::Named("n_grid") = n_grid,
        Rcpp::Named("sigma_spatial_grid") = sigma_spatial_grid,
