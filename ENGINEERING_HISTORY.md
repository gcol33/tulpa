# TULPA — Engineering History

Detailed forensic write-ups of closed issues: derivations, measured
numbers (coverage, k-hat, timing), and why a fix was correct rather than
a regression. Extracted from CLAUDE.md on 2026-09-17 to keep that file
