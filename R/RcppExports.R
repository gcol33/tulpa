...
cpp_laplace_spec_test_icar <- function(y, n, X, re_idx, n_re_groups, sigma_re, spatial_idx, n_spatial_units, adj_row_ptr, adj_col_idx, n_neighbors, tau_spatial, sigma_beta, family, phi = 1.0, max_iter = 200L, tol = 1e-10, n_threads = 1L) {
