...
#'
#' `TULPA_FAST`, `TULPA_SLOW_TESTS` and `TULPA_FULL_RECOVERY` select which cost
#' tier of the test suite runs; they are read by the suite, not by the package,
#' and are described in `tests/testthat/README.md`.
#'
#' @name tulpa-envvars
#' @keywords internal
NULL
