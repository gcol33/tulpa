...
test_that("free-Sigma random-slope nested Laplace covers the correlation rho", {
  ...
  # hyperprior = "proper" stated explicitly: the 0.75 gate was tuned against the
  # LKJ-regularized posterior.
  # Measured at 60 seeds: PC + LKJ covers 58/60 (96.7%); flat covers 49/60
